...
df = pd.read_excel('TEACHERV2SONG_rotcopy.xlsx')
#print (df)
df1 = pd.read_excel('TEACHERV2SONG_poscopy.xlsx')
#print(df1)
# df2 = pd.read_excel('capoeira800framesmodifiedv3_rot.xlsx')
df2 = pd.read_excel('studentsamemovement_rotcopy.xlsx')
df3 = pd.read_excel('studentsamemovement_poscopy.xlsx')
                    ...
                    (
                        ...
                        [
                            ...
                            (
                                ...
                                url = "static/studentsamemovementV2.mp4",
                                controls = False,
                                width = '330%',
                                height = '430%'  
                            ),
                    ...
                    (
                        ...
                        [
                            ...
                            (
                                ...
                                url = "static/teachersamemovementV3.mp4",
                                controls = False,
                                width = '330%',
                                height = '430%'  
                            ),
